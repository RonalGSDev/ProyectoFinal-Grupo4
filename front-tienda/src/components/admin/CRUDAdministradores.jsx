// src/components/CRUDAdministradores.js
import React, { useEffect, useState } from 'react';
import axios from 'axios';
import Swal from 'sweetalert2';
import LogoAdmin from '../../img/LogoAdmin.png'

const CRUDAdministradores = () => {
  ...
  return (
    <div className="container mb-5">
      ...
      <h1 className='text-center h1'>CRUD DE ADMINISTRADORES</h1>
      <img src={LogoAdmin} alt='Logotipo de productos' className='d-block m-auto img-fluid logo mb-3' />
...
export default CRUDAdministradores;
